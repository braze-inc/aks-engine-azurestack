...
func getK8sMasterVars(cs *api.ContainerService) (map[string]interface{}, error) {
	...
	cloudInitFiles := map[string]interface{}{
		...
		"provisionSource":                 getBase64EncodedGzippedCustomScript(kubernetesCSEHelpers, cs),
		...
		"provisionCIS":                    getBase64EncodedGzippedCustomScript(kubernetesCSECIS, cs),
	...
	if cs.Properties.IsCustomCloudProfile() {
		if cs.Properties.IsAzureStackCloud() {
			masterVars["apiVersionCompute"] = "2020-06-01"
			masterVars["apiVersionStorage"] = "2019-06-01"
